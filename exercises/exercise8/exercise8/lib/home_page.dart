...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('NEU Meetup')),
      body: ListView(
        children: <Widget>[
          ...
          const IconAndDetail(Icons.location_city, 'San Jose, CA'),
          const IconAndDetail(Icons.access_time, '1:18 PM - 11:18 PM'),
          const IconAndDetail(Icons.monetization_on, 'Free'),
          const IconAndDetail(Icons.people, '100+'),
          Consumer<ApplicationState>(
            builder:
