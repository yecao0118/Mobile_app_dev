...
class ApplicationState extends ChangeNotifier {
  ...
  static Map<String, dynamic> defaultValues = <String, dynamic>{
    'event_date': 'Jan 18, 2025',
    'enable_free_swag': false,
    'call_to_action': 'Join us for a day full of Interview and Pizza!',
  };
  ...
  Future<void> init() async {
    ...
    FirebaseUIAuth.configureProviders([
      EmailAuthProvider(),
      GoogleProvider(
        clientId: '644307559148-d3ingj9ndlcdcurm2ec7g5e620mun5gh.apps.googleusercontent.com',
    ),
  ]);
